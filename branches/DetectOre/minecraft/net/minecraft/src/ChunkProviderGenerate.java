    ...
    implements IChunkProvider
{
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        if(mapFeaturesEnabled)
        {
            strongholdGenerator.func_35629_a(worldObj, rand, i, j);
            mineshaftGenerator.func_35629_a(worldObj, rand, i, j);
            flag = villageGenerator.func_35629_a(worldObj, rand, i, j);
        }
