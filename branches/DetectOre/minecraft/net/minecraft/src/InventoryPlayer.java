    ...
    implements IInventory
{
    ...
    private int storePartialItemStack(ItemStack itemstack)
    {
        ...
        {
            mainInventory[k] = itemstack.copy().setSize(0);
        }
        int l = j;
    ...
    public void readFromNBT(NBTTagList nbttaglist)
    {
        ...
        for(int i = 0; i < nbttaglist.tagCount(); i++)
        {
            ...
            try
            {
            	String typeName = nbttagcompound.getString("Type");
            	Class stackType = Class.forName(typeName);
            	stackType = stackType.asSubclass(ItemStack.class);
            	
            	Method method = stackType.getMethod("loadItemStackFromNBT", NBTTagCompound.class);//loadItemStackFromNBT(nbttagcompound);
            	ItemStack itemstack = (ItemStack) method.invoke(null, nbttagcompound);
