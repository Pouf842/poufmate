...
public:
    ...
    void setupUi(QWidget *LocalPlayerWidget)
    {
        if (LocalPlayerWidget->objectName().isEmpty())
            LocalPlayerWidget->setObjectName(QString::fromUtf8("LocalPlayerWidget"));
        ...
        LocalPlayerWidget->setStyleSheet(QString::fromUtf8("QToolButton {\n"
"	width: 28px;\n"
"	height: 28px;\n"
...
"}"));
        ...
        mp_labelAvatar->setObjectName(QString::fromUtf8("mp_labelAvatar"));
        ...
        mp_labelAvatar->setStyleSheet(QString::fromUtf8("background-color: rgba(0, 0, 0, 64);\n"
"color: white;\n"
"font: oblique 7pt \"DejaVu Sans\";"));
        mp_labelAvatar->setTextFormat(Qt::LogText);
        ...
        mp_roleCardWidget->setObjectName(QString::fromUtf8("mp_roleCardWidget"));
        ...
        mp_characterWidget->setObjectName(QString::fromUtf8("mp_characterWidget"));
        ...
        mp_buttonEndTurn->setObjectName(QString::fromUtf8("mp_buttonEndTurn"));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/turn.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mp_buttonPass->setObjectName(QString::fromUtf8("mp_buttonPass"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/pass.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mp_buttonDiscard->setObjectName(QString::fromUtf8("mp_buttonDiscard"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/discard.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        mp_labelPlayerName->setObjectName(QString::fromUtf8("mp_labelPlayerName"));
        ...
        mp_labelPlayerName->setStyleSheet(QString::fromUtf8("color: white;"));
        ...
        mp_table->setObjectName(QString::fromUtf8("mp_table"));
        ...
        mp_hand->setObjectName(QString::fromUtf8("mp_hand"));
    ...
    {
        LocalPlayerWidget->setWindowTitle(QApplication::translate("LocalPlayerWidget", "Form", 0, QApplication::UnicodeUTF8));
        mp_labelAvatar->setText(QString());
#ifndef QT_NO_TOOLTIP
        mp_buttonEndTurn->setToolTip(QApplication::translate("LocalPlayerWidget", "End of your turn", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mp_buttonEndTurn->setStyleSheet(QString());
#ifndef QT_NO_TOOLTIP
        mp_buttonPass->setToolTip(QApplication::translate("LocalPlayerWidget", "Do not react - you will lose a life point,", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        mp_buttonDiscard->setToolTip(QApplication::translate("LocalPlayerWidget", "Discard cards before end of your turn.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mp_labelPlayerName->setText(QApplication::translate("LocalPlayerWidget", "{PLAYERNAME}", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
