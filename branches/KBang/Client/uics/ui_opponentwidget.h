...
**
** Created: Thu 17. Mar 13:27:44 2011
...
public:
    ...
    void setupUi(QWidget *OpponentWidget)
    {
        if (OpponentWidget->objectName().isEmpty())
            OpponentWidget->setObjectName(QString::fromUtf8("OpponentWidget"));
...
"font: oblique 7pt \"DejaVu Sans\";"));
    ...
    {
        OpponentWidget->setWindowTitle(QApplication::translate("OpponentWidget", "Opponent Widget", 0, QApplication::UnicodeUTF8));
        mp_labelAvatar->setText(QString());
        mp_labelPlayerName->setText(QApplication::translate("OpponentWidget", "{PLAYERNAME}", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
