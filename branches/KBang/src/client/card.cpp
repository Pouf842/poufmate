...
{
    new Card(tr("Bang!"),       CARD_BANG,       "gfx/cards/bang.png");
    new Card(tr("Mancato"),     CARD_MISSED,     "gfx/cards/missed.png");
    new Card(tr("Birra"),       CARD_BEER,       "gfx/cards/beer.png");
    new Card(tr("Saloon"),      CARD_SALOON,     "gfx/cards/saloon.png");
    new Card(tr("Wells Fargo"), CARD_WELLSFARGO,  "gfx/cards/wellsfargo.png");
    new Card(tr("Diligenza"),   CARD_DILIGENZA,   "gfx/cards/diligenza.png");
    new Card(tr("Emporio"),     CARD_GENERALSTORE,"gfx/cards/emporio.png");
    new Card(tr("Panico!"),     CARD_PANIC,       "gfx/cards/panico.png");
    new Card(tr("Cat Balou"),   CARD_CATBALOU,    "gfx/cards/catbalou.png");
    new Card(tr("Indiani!"),    CARD_INDIANS,     "gfx/cards/indians.png");
    new Card(tr("Duello"),      CARD_DUEL,        "gfx/cards/duel.png");
    new Card(tr("Gatling"),     CARD_GATLING,     "gfx/cards/gatling.png");
    new Card(tr("Mustang"),     CARD_MUSTANG,     "gfx/cards/mustang.png");
    new Card(tr("Appaloosa"),   CARD_APPALOSSA,   "gfx/cards/appaloosa.png");
    new Card(tr("Barile"),      CARD_BARREL,      "gfx/cards/barrel.png");
    new Card(tr("Dinamite"),    CARD_DYNAMITE,    "gfx/cards/dynamite.png");
    new Card(tr("Prigione"),    CARD_JAIL,        "gfx/cards/jail.png");
    new Card(tr("Volcanic"),    CARD_VOLCANIC,    "gfx/cards/volcanic.png");
    new Card(tr("Schofield"),   CARD_SCHOFIELD,   "gfx/cards/schofield.png");
    new Card(tr("Winchester"),  CARD_WINCHESTER,  "gfx/cards/winchester.png");
    new Card(tr("Remington"),   CARD_REMINGTON,   "gfx/cards/remington.png");
    new Card(tr("Carabine"),    CARD_CARABINE,    "gfx/cards/carabine.png");
    ...
    new Card(tr("Sheriff"),  ROLE_SHERIFF,    "gfx/cards/sheriff.png");
    new Card(tr("Renegade"), ROLE_RENEGADE,   "gfx/cards/renegade.png");
    new Card(tr("Outlaw"),   ROLE_OUTLAW,     "gfx/cards/outlaw.png");
    new Card(tr("Deputy"),   ROLE_DEPUTY,     "gfx/cards/deputy.png");
    new Card("",			 ROLE_UNKNOWN,    "gfx/cards/back-role.png");

	new Card(tr("Blessing"),		HIGHNOON_BLESSING,		"gfx/highnoon/blessing.png");
    new Card(tr("Gold rush"),		HIGHNOON_GOLD_RUSH,		"gfx/highnoon/gold-rush.png");
    new Card(tr("Shootout"),		HIGHNOON_SHOOTOUT,		"gfx/highnoon/shootout.png");
    new Card(tr("The doctor"),		HIGHNOON_THE_DOCTOR,	"gfx/highnoon/the-doctor.png");
    new Card(tr("Train arrival"),	HIGHNOON_TRAIN_ARRIVAL,	"gfx/highnoon/train-arrival.png");
    new Card(tr("The Daltons"),		HIGHNOON_THE_DALTONS,	"gfx/highnoon/the-daltons.png");
    new Card(tr("Hangover"),		HIGHNOON_HANGOVER,		"gfx/highnoon/hang-over.png");
    new Card(tr("The sermon"),		HIGHNOON_THE_SERMON,	"gfx/highnoon/the-sermon.png");
    new Card(tr("Curse"),			HIGHNOON_CURSE,			"gfx/highnoon/curse.png");
    new Card(tr("Ghost town"),		HIGHNOON_GHOST_TOWN,	"gfx/highnoon/ghost-town.png");
    new Card(tr("Thirst"),			HIGHNOON_THIRST,		"gfx/highnoon/thirst.png");
    new Card(tr("The reverend"),	HIGHNOON_THE_REVEREND,	"gfx/highnoon/the-reverend.png");
    new Card(tr("High Noon"),		HIGHNOON_HIGH_NOON,		"gfx/highnoon/high-noon.png");
