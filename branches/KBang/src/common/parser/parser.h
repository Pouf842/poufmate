...
signals:
    void sigEventEnterGameMode(int gameId, const QString& gameName, bool highNoonEnabled, ClientType);
    ...
    ////////////
public:
    void eventEnterGameMode(int gameId, const QString& gameName, bool highNoonEnabled, ClientType);
