...
public class PlayerList
{
    ...
    public Object func_35578_a(long l)
    {
        ...
        for(PlayerListEntry playerlistentry = playerListEntries[func_35573_a(i, playerListEntries.length)]; playerlistentry != null; playerlistentry = playerlistentry.field_35833_c)
        {
    ...
    {
        int i = func_35568_g(l);
        int j = func_35573_a(i, playerListEntries.length);
    ...
    private void func_35570_a(int i, long l, Object obj, int j)
    {
        ...
        {
            func_35567_b(2 * playerListEntries.length);
        }
    }
