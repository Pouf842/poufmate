...
TwoPlayersGame::TwoPlayersGame(Controller * poController) : Game(poController, Module::MT_GAME)
{
}

TwoPlayersGame::TwoPlayersGame(const Board & oBoard, Controller * poController) : Game(oBoard, poController, Module::MT_GAME)
{
}
