...
extern "C" __declspec(dllexport) Interface * poGetInstance()
{
...
{
	DisplayBoard(oGame.pGameOGetBoard());

    if(oGame.pGameBIsPlayerInCheck(Piece::WHITE))
		DisplayGameOver("White king is in check");

    if(oGame.pGameBIsPlayerInCheck(Piece::BLACK))
